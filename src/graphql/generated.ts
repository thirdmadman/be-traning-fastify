...
> = {
  post?: Resolver<ResolversTypes['Post'], ParentType, ContextType, RequireFields<QuerypostArgs, '_id'>>;
...
> = {
  ...
  strongUil?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export interface Loaders<TContext = import('mercurius').MercuriusContext & { reply: import('fastify').FastifyReply }> {
  Post?: {
    _id?: LoaderResolver<Scalars['String'], Post, {}, TContext>;
    title?: LoaderResolver<Scalars['String'], Post, {}, TContext>;
    text?: LoaderResolver<Scalars['String'], Post, {}, TContext>;
    image?: LoaderResolver<Scalars['String'], Post, {}, TContext>;
    strongUil?: LoaderResolver<Scalars['String'], Post, {}, TContext>;
  };
}
